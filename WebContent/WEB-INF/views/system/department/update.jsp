...
<body>
	...
	<div id=MainArea>
		...
		<div class=ItemBlockBorder style="margin: 0 auto; width: 1000px;">
			...
			<table>
				<tbody>
					<form:form action="updateDepartment">
						<tr>
							<td style="margin-right: 100px; display: inline-block;"><font
								color="blue">部门名称</font></td>
							<td style="margin-bottom: 50px;"><input type="text"
								name="name" class="InputStyle" value="${department.name}" /></td>
						</tr>
						<tr>
							<td><font color="blue">职能说明</font></td>
							<td><textarea class="TextareaStyle" name="description">${department.description}</textarea>
								<input type="hidden" name="did" value="${department.did}">
							</td>
						</tr>
						<tr>
							<td><input type="submit" value="submit"></td>
							<td><a href="goBack"> <img
