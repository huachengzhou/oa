...
<div id=MainArea>
	<form:form action="#" method="post" name="approveName">
        ...
        <div id="InputDetailBar" style="float:none">
			...
			同意:<input type="button" id="btn1"  src="${pageContext.request.contextPath}/css/blue/images/button/agree.png"/>
			不同意:<input type="button" id="btn2" src="${pageContext.request.contextPath}/css/blue/images/button/disagree.png"/>
